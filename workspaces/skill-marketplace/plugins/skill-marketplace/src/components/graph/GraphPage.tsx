  ...
  return (
    <div className={styles.graphPageRoot}>
      ...
      <div className={styles.graphBody}>
        ...
        {!g.aiPanelOpen && g.agenticAvailable && (
          <button
            className={styles.floatingAskAi}
            onClick={g.handleToggleAiPanel}
            type="button"
            aria-label="Open Knowledge Graph AI Chat"
            title="Ask AI about the knowledge graph"
          >
            <svg
              viewBox="0 0 24 24"
              width={18}
