...
export const builderStyles = `
  ...
  .sb-tool-chip:hover { background: #ffe0b2; }
  .sb-tool-args {
    margin-top: 4px;
    margin-left: 30px;
    padding: 6px 10px;
  ...
  @keyframes sb-pulse {
    ...
    50% { box-shadow: 0 0 0 4px rgba(0,102,204,0); }
  }
  .sb-copy-btn {
    padding: 3px 10px;
    border: 1px solid var(--pf-t--global--border--color--default, #d2d2d2);
  ...
  .sb-clear-btn:hover { opacity: 1; text-decoration: underline; }
`;
